...
#define PLAYER_ATTACK_EFFECT_01      (9)                                // 攻撃のエフェクトを出すタイミング(2つ目)
#define PLAYER_ATTACK_EFFECT_02      (20)                               // 攻撃のエフェクトを出すタイミング(3つ目)
#define PLAYER_ATTACK_EFFECT_03      (29)                               // 攻撃のエフェクトを出すタイミング(4つ目)

#define PLAYER_ATTACK_MOVE_00        (9)                                // 攻撃時に動き出すタイミング(1つ目)
#define PLAYER_ATTACK_MOVE_01        (7)                                // 攻撃時に動き出すタイミング(2つ目)
#define PLAYER_ATTACK_MOVE_02        (17)                               // 攻撃時に動き出すタイミング(3つ目)
